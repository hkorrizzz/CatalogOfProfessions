...
- Год разработки: 2023
- Технологический стек: язык C#, платформа .NET MAUI, среда разработки Microsoft Visual Studio 2022, формат хранения данных XML
...
Главный экран c поиском, сортировкой
![Главный экран](Screenshots/Главный экран.png)

Список профессий в направлении
![Список профессий](Screenshots/professions_list.png)

Детальная информация о профессии
![Информация о профессии](Screenshots/profession_info.png)

### Добавление новой профессии
![Добавление профессии](Screenshots/add_profession.png)

### Удаление профессии
![Удаление профессии](Screenshots/delete_profession.png)
